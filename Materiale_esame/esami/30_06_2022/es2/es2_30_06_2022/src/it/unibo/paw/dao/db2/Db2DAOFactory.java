...
public class Db2DAOFactory extends DAOFactory {
	...
	public SquadraDAO getSquadraDAO() {
		return new Db2SquadraDAO();
	}

	@Override
	public GiocatoreDAO getGiocatoreDAO() {
		return new Db2GiocatoreDAO();
	}
	
	@Override
	public SquadraGiocatoreMappingDAO getSquadraGiocatoreMappingDAO() {
		return new Db2SquadraGiocatoreMappingDAO();
	}
